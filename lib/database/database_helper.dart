...
await db.insert('restaurants', {
  ...
  'imageUrl': 'lib/assets/images/amalfi.jpg',
  'phone': '404-000-0000',
...
await db.insert('restaurants', {
  ...
  'imageUrl': 'lib/assets/images/panda_express.jpg',
  'phone': '404-000-0000',
...
await db.insert('restaurants', {
  ...
  'distance': 0.2,
  'hours': '11:00 AM - 10:00 PM',
  'imageUrl': 'lib/assets/images/hibachi.jpg',
  'phone': '404-000-0000',
...
await db.insert('restaurants', {
  ...
  'imageUrl': 'lib/assets/images/pho.jpg',
  'phone': '404-000-0000',
...
await db.insert('restaurants', {
  ...
  'distance': 0.1,
  'hours': '10:30 AM - 9:00 PM',
  'imageUrl': 'lib/assets/images/moes.jpg',
  'phone': '404-000-0000',
...
await db.insert('restaurants', {
  ...
  'distance': 0.6,
  'hours': '11:00 AM - 10:00 PM',
  'imageUrl': 'lib/assets/images/tin_lizzy.jpg',
  'phone': '404-000-0000',
...
await db.insert('restaurants', {
  ...
  'imageUrl': 'lib/assets/images/hungryaf.jpg',
  'phone': '404-000-0000',
...
await db.insert('restaurants', {
  ...
  'imageUrl': 'lib/assets/images/metro.jpg',
  'phone': '404-000-0000',
...
await db.insert('restaurants', {
  ...
  'imageUrl': 'lib/assets/images/mrfries.jpg',
  'phone': '404-254-4381',
...
await db.insert('restaurants', {
  ...
  'imageUrl': 'lib/assets/images/chickfila.jpg',
  'phone': '404-000-0000',
  'address': '55 Gilmer St SE, Atlanta, GA 30303',
...
await db.insert('restaurants', {
  ...
  'imageUrl': 'lib/assets/images/broad.jpg',
  'phone': '404-000-0000',
  'address': '60 Broad St NW, Atlanta, GA 30303',
...
await db.insert('restaurants', {
  ...
  'imageUrl': 'lib/assets/images/gusto.jpg',
  'phone': '404-254-4197',
...
await db.insert('restaurants', {
  ...
  'imageUrl': 'lib/assets/images/tin_drum.jpg',
  'phone': '404-000-0000',
...
await db.insert('restaurants', {
  ...
  'distance': 0.2,
  'hours': '11:00 AM - 9:00 PM',
  'imageUrl': 'lib/assets/images/gyro.jpg',
  'phone': '404-000-0000',
...
await db.insert('restaurants', {
  ...
  'imageUrl': 'lib/assets/images/ag_steakhouse.jpg',
  'phone': '404-221-6550',
...
await db.insert('restaurants', {
  ...
  'distance': 0.5,
  'hours': '11:00 AM - 10:00 PM',
  'imageUrl': 'lib/assets/images/whiteoak.jpg',
  'phone': '404-524-7200',
...
await db.insert('restaurants', {
  ...
  'distance': 0.7,
  'hours': '11:00 AM - 10:00 PM',
  'imageUrl': 'lib/assets/images/rays.jpg',
  'phone': '404-524-9224',
...
await db.insert('restaurants', {
  ...
  'imageUrl': 'lib/assets/images/cuts.jpg',
  'phone': '404-525-3399',
...
await db.insert('restaurants', {
  ...
  'imageUrl': 'lib/assets/images/polaris.jpg',
  'phone': '404-460-6425',
...
await db.insert('restaurants', {
  ...
  'imageUrl': 'lib/assets/images/saxbys.jpg',
  'phone': '404-413-9500',
  'address': '66 Courtland St SE, Atlanta, GA 30303',
...
await db.insert('restaurants', {
  ...
  'distance': 0.4,
  'hours': '11:00 AM - 9:00 PM',
  'imageUrl': 'lib/assets/images/naanstop.jpg',
  'phone': '404-343-1808',
...
await db.insert('restaurants', {
  ...
  'distance': 0.9,
  'hours': '11:00 AM - 10:00 PM',
  'imageUrl': 'lib/assets/images/botiwalla.jpg',
  'phone': '404-343-1808',
...
await db.insert('restaurants', {
  ...
  'distance': 0.8,
  'hours': '11:00 AM - 10:00 PM',
  'imageUrl': 'lib/assets/images/planet_bombay.jpg',
  'phone': '404-688-0005',
...
await db.insert('restaurants', {
  ...
  'imageUrl': 'lib/assets/images/dunkin.jpg',
  'phone': '404-555-1234',
  'address': '66 Courtland St SE, Atlanta, GA 30303',
...
await db.insert('restaurants', {
  ...
  'distance': 0.6,
  'hours': '8:00 AM - 4:00 PM',
  'imageUrl': 'lib/assets/images/juliannas.jpg',
  'phone': '404-883-3406',
...
await db.insert('restaurants', {
  ...
  'imageUrl': 'lib/assets/images/condesa.jpg',
  'phone': '404-524-5054',
